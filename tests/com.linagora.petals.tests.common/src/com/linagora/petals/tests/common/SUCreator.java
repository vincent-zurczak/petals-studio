...
package com.linagora.petals.tests.common;
...
public class SUCreator {
	...
	public static SUDesc createFileTransferEndpoint(final SWTWorkbenchBot bot) {
		...
		bot.perspectiveById( "com.linagora.petals.common.mainPerspective" ).activate();
		...
		SWTBotView view = bot.viewById("com.linagora.petals.common.projects");
		view.show();
		view.setFocus();

 ...
 * <ul>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getWsaReplyTo <em>Wsa Reply To</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getWsaFrom <em>Wsa From</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getWsaFaultTo <em>Wsa Fault To</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getSoapVersion <em>Soap Version</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#isChunkedMode <em>Chunked Mode</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getSynchonousTimeout <em>Synchonous Timeout</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#isCleanupTransport <em>Cleanup Transport</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getProxyHost <em>Proxy Host</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getProxyPort <em>Proxy Port</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getProxyUser <em>Proxy User</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getProxyPassword <em>Proxy Password</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getProxyDomain <em>Proxy Domain</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getHeadersFilter <em>Headers Filter</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getInjectHeaders <em>Inject Headers</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getHeadersToInject <em>Headers To Inject</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getHttpBasicAuthUsername <em>Http Basic Auth Username</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getHttpBasicAuthPassword <em>Http Basic Auth Password</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getEnableCompatibilityFor <em>Enable Compatibility For</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#isEnableWsa <em>Enable Wsa</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getHttpsTruststoreFile <em>Https Truststore File</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getHttpsTruststorePassword <em>Https Truststore Password</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getHttpsKeystoreFile <em>Https Keystore File</em>}</li>
 *   <li>{@link com.linagora.petals.services.soap.soap.impl.SoapProvidesImpl#getHttpsKeystorePassword <em>Https Keystore Password</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

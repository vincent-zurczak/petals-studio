...
public class CamelAdapterFactory extends AdapterFactoryImpl {
	...
	protected CamelSwitch<Adapter> modelSwitch =
		new CamelSwitch<Adapter>() {
			@Override
			public Adapter caseCamelConsumes(CamelConsumes object) {
				return createCamelConsumesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.linagora.petals.services.camel.camel.CamelConsumes <em>Consumes</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCamelConsumesAdapter() {
		return null;
	}

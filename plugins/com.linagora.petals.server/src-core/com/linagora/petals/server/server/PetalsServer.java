...
package com.linagora.petals.server.server;
...
import com.linagora.petals.server.runtime.PetalsRuntime;
import com.linagora.petals.server.utils.NetworkUtils;
...
implements IPetalsServer, IPetalsServerWorkingCopy {
	...
	/* (non-Javadoc)
	 * @see com.linagora.petals.server.server.IPetalsServer
	...
	/*
	 * (non-Javadoc)
	 * @see com.linagora.petals.server.server.IPetalsServerWorkingCopy
	 * #isRunning()
	 */

...
import com.ebmwebsourcing.petals.services.rest.rest.Consumes;
import com.ebmwebsourcing.petals.services.rest.rest.ConsumesMapping;
...
import com.ebmwebsourcing.petals.services.rest.rest.Provides;
...
import com.ebmwebsourcing.petals.services.rest.rest.restFactory;
...
public class restPackageImpl extends EPackageImpl implements restPackage {
	 ...
	 * @see com.ebmwebsourcing.petals.services.rest.rest.restPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getConsumes_BasePath() {
	 ...
	 * @generated
	 */
	public EReference getConsumes_Mapping() {
	 ...
	 * @generated
	 */
	public EAttribute getProvides_BasePath() {
	 ...
	 * @generated
	 */
	public EReference getProvides_Mapping() {
	...
	public void createPackageContents() {
		...
		createEAttribute(consumesEClass, CONSUMES__BASE_PATH);
		createEReference(consumesEClass, CONSUMES__MAPPING);
		...
		createEAttribute(providesEClass, PROVIDES__BASE_PATH);
		createEReference(providesEClass, PROVIDES__MAPPING);
	...
	public void initializePackageContents() {
		...
		consumesEClass.getESuperTypes().add(theJbiPackage.getConsumes());
		onCaseEClass.getESuperTypes().add(this.getCondition());
		providesEClass.getESuperTypes().add(theJbiPackage.getProvides());
		...
		initEAttribute(getConsumes_BasePath(), theXMLTypePackage.getString(), "basePath", null, 1, 1, Consumes.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConsumes_Mapping(), this.getConsumesMapping(), null, "mapping", null, 1, 1, Consumes.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProvides_BasePath(), theXMLTypePackage.getString(), "basePath", null, 1, 1, Provides.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProvides_Mapping(), this.getProvidesMapping(), null, "mapping", null, 1, 1, Provides.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

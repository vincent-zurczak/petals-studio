...
public abstract class RestDescription extends ComponentVersionDescription {
	...
	/* (non-Javadoc)
	 * @see com.ebmwebsourcing.petals.services.su.extensions.IComponentDescription#isBc()
	 */
	@Override
	public boolean isBc() {
		return true;
	...
	/* (non-Javadoc)
	 * @see com.ebmwebsourcing.petals.services.su.extensions.IComponentDescription#getComponentName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.ebmwebsourcing.petals.services.su.extensions.IComponentDescription#getComponentAlias()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.ebmwebsourcing.petals.services.su.extensions.IComponentDescription#getComponentAnnotation()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.ebmwebsourcing.petals.services.su.extensions.IComponentDescription#getProvideDescription()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.ebmwebsourcing.petals.services.su.extensions.IComponentDescription#getKeyWords()
	 */
	@Override

 ...
 */
public class PetalsRestPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.services.rest"; //$NON-NLS-1$

	// The shared instance
	private static PetalsRestPlugin plugin;

	/**
	 * The constructor
	 */
	public PetalsRestPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsRestPlugin getDefault() {
		return plugin;
	}

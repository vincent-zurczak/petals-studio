 ...
 */
package com.ebmwebsourcing.petals.services.camel.camel.util;
 ...
 * <!-- end-user-doc -->
 * @see com.ebmwebsourcing.petals.services.camel.camel.CamelPackage
 * @generated
 */
public class CamelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CamelPackage.CAMEL_CONSUMES: {
				CamelConsumes camelConsumes = (CamelConsumes)theEObject;
				T result = caseCamelConsumes(camelConsumes);
				if (result == null) result = caseConsumes(camelConsumes);
				if (result == null) result = caseAbstractEndpoint(camelConsumes);
				if (result == null) result = caseAbstractExtensibleElement(camelConsumes);
	 ...
	 * @generated
	 */
	public T caseCamelConsumes(CamelConsumes object) {
		return null;
	}

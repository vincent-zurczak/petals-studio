...
package com.linagora.petals.services.filetransfer.v24.wizard;
...
import com.linagora.petals.services.filetransfer.FileTransferPlugin;
...
import com.linagora.petals.services.filetransfer.v24.wizard.FileTransferProvidesWizard24.Contract;
...
public class FiletransferProvidesPage extends AbstractSuWizardPage {
	...
	/*
	 * (non-Javadoc)
	 * @see com.linagora.petals.tools.eclipse.su.main.pages.XsdBasedAbstractSuPage
	 * #dialogChanged()
	 */
	@Override

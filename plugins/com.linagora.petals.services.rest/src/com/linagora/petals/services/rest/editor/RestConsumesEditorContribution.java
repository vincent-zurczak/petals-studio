 ...
 */
public class RestConsumesEditorContribution extends JbiEditorDetailsContribution {
	...
	public void addAdvancedSUContent(AbstractEndpoint endpoint, FormToolkit toolkit, Composite advancedTab, ISharedEdition ise) {
		...
		composite = createEditorSection( advancedTab, toolkit, "REST" );
		EObjectUIHelper.generateWidgets(
				...
				true,
				RestPackage.Literals.REST_CONSUMES__BASE_PATH );
	}
}

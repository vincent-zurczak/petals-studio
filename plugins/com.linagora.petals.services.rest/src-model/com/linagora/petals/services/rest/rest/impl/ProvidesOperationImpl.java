 ...
 * </p>
 * <ul>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getHttpMethod <em>Http Method</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getWadl <em>Wadl</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getWsdl2 <em>Wsdl2</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getHttpBodyType <em>Http Body Type</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#isBufferRequest <em>Buffer Request</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#isTrustAllCertificates <em>Trust All Certificates</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getXpathParam <em>Xpath Param</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getAuthentication <em>Authentication</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getHeaders <em>Headers</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getXsl <em>Xsl</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getResponseBodyAs <em>Response Body As</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getJsonXmlMappingConvention <em>Json Xml Mapping Convention</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getFormData <em>Form Data</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getOnHttpStatus <em>On Http Status</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#isHttpBodyToJsonMultiplePi <em>Http Body To Json Multiple Pi</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#isHttpBodyFromJsonMultiplePi <em>Http Body From Json Multiple Pi</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getHttpBodyToJsonVirtualRoot <em>Http Body To Json Virtual Root</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getHttpBodyFromJsonVirtualRoot <em>Http Body From Json Virtual Root</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#isHttpBodyToJsonAutoArray <em>Http Body To Json Auto Array</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#isHttpBodyToJsonAutoPrimitive <em>Http Body To Json Auto Primitive</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#isHttpBodyToJsonPrettyPrint <em>Http Body To Json Pretty Print</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#isHttpBodyToJsonNsDeclarations <em>Http Body To Json Ns Declarations</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ProvidesOperationImpl#getNamespaceMapping <em>Namespace Mapping</em>}</li>
 * </ul>
 *
 * @generated
 */

 ...
 * </p>
 * <ul>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#getBasePath <em>Base Path</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#isHttpBodyFromJsonMultiplePi <em>Http Body From Json Multiple Pi</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#getHttpBodyFromJsonVirtualRoot <em>Http Body From Json Virtual Root</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#isHttpBodyToJsonAutoArray <em>Http Body To Json Auto Array</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#isHttpBodyToJsonAutoPrimitive <em>Http Body To Json Auto Primitive</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#isHttpBodyToJsonMultiplePi <em>Http Body To Json Multiple Pi</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#isHttpBodyToJsonNsDeclarations <em>Http Body To Json Ns Declarations</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#isHttpBodyToJsonPrettyPrint <em>Http Body To Json Pretty Print</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#getHttpBodyToJsonVirtualRoot <em>Http Body To Json Virtual Root</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.DocumentRootImpl#getNamespaceMapping <em>Namespace Mapping</em>}</li>
 * </ul>
 *
 * @generated
 */

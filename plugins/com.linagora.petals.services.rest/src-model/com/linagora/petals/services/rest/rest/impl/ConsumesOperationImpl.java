 ...
 * </p>
 * <ul>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ConsumesOperationImpl#getHttpMethod <em>Http Method</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ConsumesOperationImpl#getPathTemplate <em>Path Template</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ConsumesOperationImpl#getHttpBodyFromJsonVirtualRoot <em>Http Body From Json Virtual Root</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ConsumesOperationImpl#getIncomingPayload <em>Incoming Payload</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ConsumesOperationImpl#isHttpBodyFromJsonMultiplePi <em>Http Body From Json Multiple Pi</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ConsumesOperationImpl#getHttpBodyFromJsonVirtualRoot1 <em>Http Body From Json Virtual Root1</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ConsumesOperationImpl#getXmlTemplate <em>Xml Template</em>}</li>
 *   <li>{@link com.linagora.petals.services.rest.rest.impl.ConsumesOperationImpl#getOnJbiResponse <em>On Jbi Response</em>}</li>
 * </ul>
 *
 * @generated
 */

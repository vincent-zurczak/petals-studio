...
package com.linagora.petals.services.su.editor;
...
import com.linagora.petals.common.internal.provisional.swt.OpenSourceEditorHyperlinkListener;
...
import com.linagora.petals.services.su.editor.extensibility.defaultpages.DefaultJbiEditorContribution;
import com.linagora.petals.services.su.editor.su.EMFPCStyledLabelProvider;
import com.linagora.petals.services.su.editor.wizards.AddConsumesToExistingJbiStrategy;
import com.linagora.petals.services.su.editor.wizards.AddProvidesToExistingJbiStrategy;
...
public class SuEditionComposite extends SashForm implements ISharedEdition {
	...
	/*
	 * (non-Javadoc)
	 * @see com.linagora.petals.services.su.editor.ISharedEdition
	 * #getEditingDomain()
	 */
	@Override

...
import com.linagora.petals.common.internal.provisional.builder.JbiXmlBuilder;
import com.linagora.petals.common.internal.provisional.builder.MarkerBean;
...
import com.linagora.petals.common.internal.provisional.utils.EmfUtils;
...
import com.linagora.petals.common.internal.provisional.utils.XPathUtils;
...
import com.linagora.petals.services.su.extensions.ValidationRule;
import com.linagora.petals.services.su.jbiproperties.PetalsSPPropertiesManager;
import com.linagora.petals.services.utils.ConsumeUtils;
...
public class SuBuilder extends JbiXmlBuilder {
	 ...
	 */
	public static final String BUILDER_ID = "com.linagora.petals.tools.eclipse.su.main.suBuilder";	 //$NON-NLS-1$

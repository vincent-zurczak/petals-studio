...
package com.linagora.petals.services.wizards;
...
import com.linagora.petals.services.sa.nature.SaNature;
...
import com.linagora.petals.services.su.nature.SuNature;
...
public class FileStructureImportWizardPage extends WizardPage {
	...
	public FileStructureImportWizardPage () {
		...
		try {
			...
			desc = AbstractUIPlugin.imageDescriptorFromPlugin( "com.linagora.petals.component", "icons/component.png" );
			if( desc != null )
				this.componentImg = desc.createImage();

			desc = AbstractUIPlugin.imageDescriptorFromPlugin( "com.linagora.petals.component", "icons/shared_library_16x16.png" );
			if( desc != null )

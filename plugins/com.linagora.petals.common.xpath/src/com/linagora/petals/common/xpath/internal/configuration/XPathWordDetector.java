...
public class XPathWordDetector implements IWordDetector {
	...
	static public class NCNameWordDetector extends XPathWordDetector {
		...
		/*
		 * (non-Javadoc)
		 * @see com.linagora.petals.common.xpath.internal.configuration.XPathWordDetector
		 * #isWordPart(char)
		 */
		@Override
	...
	static public class VariableDetector extends NCNameWordDetector {
		 ...
		 * @see com.linagora.petals.common.xpath.internal.configuration.XPathWordDetector#isWordStart(char)
		 */
		@Override
